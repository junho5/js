...
async function getUser() {
    try {
      ...
      const res = await axios.get('/student_attendance/users');
      ...
      Object.keys(users).map(function (key) {
        ...
        edit.addEventListener('click', async () => {
          ...
          try {
            ...
            await axios.put('/student_attendance/user/' + key, { name, memo });
            getUser();
          } catch (err) {
            console.error(err);
          }
        ...
        remove.addEventListener('click', async () => {
          try {
            ...
            await axios.delete('/student_attendance/user/' + key);
            getUser();
          } catch (err) {
            console.error(err);
          }
  ...
  document.getElementById('form').addEventListener('submit', async (e) => {
    ...
    try {
      ...
      await axios.post('/student_attendance/user', { name, memo });
      getUser();
    } catch (err) {
      console.error(err);
    }
